...
export default function Footer() {
  return (
    <>
        <footer className="footer-main-tag">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                  <div className="mb-6 md:mb-0">
                      <a href="#" className="flex items-center">
                          <img src={require('../logowhite.png')} className="h-11 me-3" alt="Logo" />
                      </a>
                  ...
                  <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                      ...
                      <div>
                          ...
                          <ul className="text-gray-500 font-medium">
                              <li className="mb-4">
                                  <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Pricing</a>
                              </li>
                              <li className='mb-4'>
                                  <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Customers</a>
                              </li>
                              <li>
                                  <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Products</a>
                              </li>
                          </ul>
                      </div>
                  </div>
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                  <span className="text-sm text-gray-500 sm:text-center">© 2024 <a href="#" className="hover:underline">AI Legal Chatbot</a>. All Rights Reserved.</span>
